package com.example.shared;//package com.example.goorm_ticket.api.coupon.service;
//
...
//
//@SpringBootTest
//class CouponAllocationServiceTest {
//    @Autowired
...
//
//        // when
//        List<CouponResponseDto> couponList = couponAllocationService.getAllCoupons();
//
//        // then
...
//
//        // when
//        List<CouponResponseDto> userCoupons = couponAllocationService.getUserCoupons(user.getId());
//
//        // then
...
//
//        // when, then
//        assertThatThrownBy(() -> couponAllocationService.getUserCoupons(999L))
...
//
//        // when, then
//        assertThatThrownBy(() -> couponAllocationService.decreaseCoupon(coupon.getId()))
...
//
//        // when
//        couponAllocationService.decreaseCoupon(coupon.getId());
